...
- ```neural_style_transfer.py```: create a directory train-style at the same place as the file. This directory contains directories of all the classes with images generated by style transfer within the class. It needs to be at the same level as the train directory that contains the labeled data. The generated images are available on the Google Drive.
