...
def create_submission(train_path, test_path, test_transform, batch_size, checkpoint_path, num_classes = 10):
    ...
    model = ConvNextFinetune(num_classes).to(device)
    ...
    submission.to_csv(f"submission_convnext.csv", index=False)
