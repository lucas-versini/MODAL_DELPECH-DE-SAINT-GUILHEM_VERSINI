...
def train():
    ...
    for iteration in tqdm(range(20)):
        # Define the model
        model = ConvNextFinetune(num_classes, True).to(device)
...
# Paths to images, and to files where results are stored
results_path = "results_convnext.txt"
model_path = "model_convnext.pth"
data_path = "data_convnext.pth"
